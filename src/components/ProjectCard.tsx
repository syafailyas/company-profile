  ...
  return (
    <div className = "flex flex-col lg:flex-row lg:gap-[30px] rounded-md overflow-hidden">
      <div
        className =
        {
          `relative w-full h-[250px] md:h-[300px] lg:h-[450px] lg:rounded-3xl overflow-hidden ${
      ...
      <div
        className =
        {
          `flex flex-col justify-center space-y-6 px-[30px] py-[30px] lg:w-[600px] lg:rounded-3xl bg-secondary/10 ${
