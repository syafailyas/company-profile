...
import culture01 from "@/assets/images/culture-01.png";
...
[
  {
    ratings: 5,
    clientTestimonial:
      "Exceptional work! Supernova revamped our website and keeps it running smoothly with their maintenance services. Couldn't be happier!",
...

  {
    ratings: 5,
    clientTestimonial:
      "Professional and reliable! Supernova not only built us a stunning website but also ensures it stays up-to-date and secure. Highly recommended!",
    clientName: "Andrew Stevenson",
...

  {
    ratings: 5,
    clientTestimonial:
      "Top-notch service! Supernova handles all our web development and maintenance needs seamlessly. Their expertise has truly elevated our online presence.",
    clientName: "Agnes Johnson",
...
[
...

  {
    ...
    description:
      "Innovation is the lifeblood of Supernova. We foster an environment where creativity flourishes, encouraging our team members to think outside the box and push boundaries. Collaboration is key, as we believe the best ideas emerge from diverse perspectives working together towards a common goal. We embrace experimentation and are not afraid to take calculated risks to stay ahead of the curve in an ever-evolving digital landscape.",
    imgUrl: culture02,
  },
